			...
			<table width="100%">
				<tbody>
				    ...
				    <tr>
				        ...
				        <td colspan="3">#LSCurrencyFormat(NumAns01, "local")#</td>
				    </tr>
				    <!---/ Total Project Budget --->
				    ...
				    <tr>
				        ...
				        <td colspan="3">
				        	...
				        	<p>
								...
								#apr18_Alcohol_Total# abused alcohol, 

								#apr18_Drug_Total# abused drugs, 
				        	...
				        	<cfif apr19DV_Yes_Total NEQ 0>
				        		<p>#apr19DV_Yes_Total# of the persons served had past domestic violence experience; #DVPastYear# had domestic violence experience in the past year.</p>
