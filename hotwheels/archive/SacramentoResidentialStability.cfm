<cfoutput>
	<div class="row">
		<div class="large-12 columns text-left">
			...
			<div class="row">
		<div class="large-12 columns text-left">
					<p> <p>Disregarding the #NumberStayersLessThan6Months# stayers who have been in the program less than 6 months, #NumberFormat(PercPersonsRemaininPHOver6MonthsorExitToPH*100)#% of participants remained housed for at least 6 months, or exited to permanent housing.</p>	    
				...
				<p>
						...
						<cfset ExitPermONS = (apr29More90_OwnedNoSubsidy_Total+apr29More90_OwnedSubsidy_Total+apr29Less90_OwnedNoSubsidy_Total+apr29Less90_OwnedSubsidy_Total)>
							...
							<cfset ExitPermPSH = (apr29Less90_PSH_Total+apr29More90_PSH_Total)>
			...
			<p>
				...
				<cfif (apr29Less90_InstTotal_Total+apr29More90_InstTotal_Total) GT 0> #(apr29More90_Jail_Total+apr29Less90_Jail_Total)# in jail.</cfif>
			</p>
			<!---/ Inst Sentences --->
		</div>
	</div>
