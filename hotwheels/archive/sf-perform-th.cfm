 	...
 	<div class="large-12 columns">
		<div class="panel BGLightGray">
			...
			<ul>
				...
				<li>With a community target of 95%, the percentage of participants with non-cash mainstream benefits (including health insurance) by follow-up/exit is #NumberFormat((PerNonCashBens)*100,"0")#%.
</li>
