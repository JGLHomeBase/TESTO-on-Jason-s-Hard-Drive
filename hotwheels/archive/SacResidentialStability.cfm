		...
		<div class="large-12 columns text-left">
				...
				<p>
						...
						<cfelse>.</cfif> </cfif><p>
                                ...
                                <p>Disregarding the #NumberStayersLessThan6Months# stayers who have been in the program less than 6 months, #NumberFormat(PercPersonsRemaininPHOver6MonthsorExitToPH*100)#% of participants remained housed for at least 6 months, or exited to permanent housing.	  
					</p>
				<!---/ PSH-SHP and S+C --->
