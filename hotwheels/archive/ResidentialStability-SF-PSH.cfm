<cfoutput>
	<div class="row">
		...
		<div class="large-12 columns text-left">
					...
					<p>#NumberPersonsRemainedPHOrExitedToPH# of #apr08_Total# (#NumberFormat(PercPersonsRemainedPHOrExitedToPH*100, "__")#%) of project participants achieved housing stability by remaining in permanent housing or exiting to permanent housing.</p>
