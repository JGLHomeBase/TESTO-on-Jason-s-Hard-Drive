		...
		<div class="large-12 columns">
			...
			<tbody>
				...
				<tr>
					...
					<td valign="top" class="text-center">
						#apr24Leavers_NumOverall_Same# of #apr25Leavers_Total_Adults#
						(#NumberFormat(PercLeaversWithSameAtExit*100, "__")#%)
					</td>
					<td valign="top" class="text-center">
						#apr24Stayers_NumOverall_Same# of #apr25Stayers_Total_Adult#
			...
			<div class="large-12 columns">
						<table width="100%">
							...
							<tbody>
                                ...
                                <tr>
									<td valign="top">
										Average Percentage Increase in Income from Entry to Follow Up or Exit (Assumes highest end of APR range; maximum income of $2250/month.)
									</td>
									<td valign="top" class="text-center">
										#(NumberFormat(Bobby*100, "__"))#%
									</td>
								</tr>
							</tbody>
						</table>
