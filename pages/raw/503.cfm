 ...
 .sign.error-page-wrapper .buttons-container a:hover .fa-home {
  ...
  @media screen and (max-width: 500px) {
   ...
   .sign.error-page-wrapper .buttons-container .fa {
    ...
    .background-color {
      background-color: rgba(45, 178, 255, 1) !important;
    }
    ...
    .secondary-text-color {
      color: rgba(0, 115, 196, 1) !important;
    }

    .sign-text-color {
      color: rgba(255, 143, 13, 1) !important;
    }
...
<div class="text-container">
  ...
  <div class="context primary-text-color">
	...
	<div class="buttons-container">
		<cfoutput>
            <a class="border-button" href="#FullURL#" target="_blank"><span class="fa fa-home"></span> Home Page</a>
            <a class="border-button" href="#HelpEmail#" target="_blank"><span class="fa fa-warning"></span> Report Problem</a>
        </cfoutput>
	</div>
</div>
